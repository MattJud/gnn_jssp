...
class DisjunctiveGraph3x3(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None):
        super(DisjunctiveGraph3x3, self).__init__(root, transform, pre_transform)
    ...
    def processed_file_names(self):
        return ['../input/DisjunctiveGraph3x3.pt'] #Has to create 'input' folder if hasn't been created yet, otherwise Errno 2,no such directory will be thrown
...
class DisjunctiveGraph6x6(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None):
        super(DisjunctiveGraph6x6, self).__init__(root, transform, pre_transform)
        self.data, self.slices = torch.load(self.processed_paths[0])
    ...
    @property
    def processed_file_names(self):
        return ['../input/DisjunctiveGraph6x6.pt'] #Has to create 'input' folder if hasn't been created yet, otherwise Errno 2,no such directory will be thrown
...
class DisjunctiveGraph6x6L2D(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None):
        super(DisjunctiveGraph6x6L2D, self).__init__(root, transform, pre_transform)
        self.data, self.slices = torch.load(self.processed_paths[0])
    ...
    @property
    def processed_file_names(self):
        return ['../input/DisjunctiveGraph6x6L2D.pt'] #Has to create 'input' folder if hasn't been created yet, otherwise Errno 2,no such directory will be thrown
...
class DisjunctiveGraph8x8(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None):
        super(DisjunctiveGraph8x8, self).__init__(root, transform, pre_transform)
        self.data, self.slices = torch.load(self.processed_paths[0])
    ...
    @property
    def processed_file_names(self):
        return ['../input/DisjunctiveGraph8x8.pt'] #Has to create 'input' folder if hasn't been created yet, otherwise Errno 2,no such directory will be thrown
...
class DisjunctiveGraph10x10(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None):
        super(DisjunctiveGraph10x10, self).__init__(root, transform, pre_transform)
        self.data, self.slices = torch.load(self.processed_paths[0])
    ...
    @property
    def processed_file_names(self):
        return ['../input/DisjunctiveGraph10x10.pt'] #Has to create 'input' folder if hasn't been created yet, otherwise Errno 2,no such directory will be thrown
...
class DisjunctiveGraph15x15(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None):
        super(DisjunctiveGraph15x15, self).__init__(root, transform, pre_transform)
        self.data, self.slices = torch.load(self.processed_paths[0])
    ...
    @property
    def processed_file_names(self):
        return ['../input/DisjunctiveGraph15x15.pt'] #Has to create 'input' folder if hasn't been created yet, otherwise Errno 2,no such directory will be thrown
...
class DisjunctiveGraph15x15L2D(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None):
        super(DisjunctiveGraph15x15L2D, self).__init__(root, transform, pre_transform)
        self.data, self.slices = torch.load(self.processed_paths[0])
    ...
    @property
    def processed_file_names(self):
        return ['../input/DisjunctiveGraph15x15L2D.pt'] #Has to create 'input' folder if hasn't been created yet, otherwise Errno 2,no such directory will be thrown
